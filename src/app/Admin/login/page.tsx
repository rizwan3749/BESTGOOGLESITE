...
export default function SignInPage() {
  ...
  return (
    <div className="flex items-center justify-center  h-[80vh]">
      <div className="max-w-md w-full mt-4 shadow-xl rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-neutral-50 dark:bg-black">
        ...
        <form className="my-8" onSubmit={handleEmailSignIn}>
          ...
          <button
            className="bg-gradient-to-br from-black dark:from-zinc-50 dark:to-zinc-300 to-neutral-600 block dark:bg-zinc-100 w-full text-white dark:text-black rounded-md h-10 font-medium"
            type="submit"
            disabled={loading}
          >
